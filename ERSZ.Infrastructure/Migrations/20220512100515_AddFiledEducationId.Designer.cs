...
namespace ERSZ.Infrastructure.Migrations
{
    ...
    [Migration("20220512100515_AddFiledEducationId")]
    partial class AddFiledEducationId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Contracts.LogOperation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("CaseTypeId")
                        .HasDatabaseName("ix_case_data_case_type_id");

                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_case_data_court_id");

                    b.ToTable("case_data", (string)null);
                });

            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseDismissal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("DismissalKind")
                        .HasColumnType("text")
                        .HasColumnName("dismissal_kind");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_case_dismissal");

                    b.HasIndex("CaseId")
                        .HasDatabaseName("ix_case_dismissal_case_id");

                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_case_dismissal_court_id");

                    b.HasIndex("JurorId")
                        .HasDatabaseName("ix_case_dismissal_juror_id");

                    b.ToTable("case_dismissal", (string)null);
                });

            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSelectionProtokol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("JurorMandateId")
                        .HasColumnType("integer")
                        .HasColumnName("juror_mandate_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_case_selection_protokol");

                    b.HasIndex("CaseId")
                        .HasDatabaseName("ix_case_selection_protokol_case_id");

                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_case_selection_protokol_court_id");

                    b.HasIndex("JurorMandateId")
                        .HasDatabaseName("ix_case_selection_protokol_juror_mandate_id");

                    b.ToTable("case_selection_protokol", (string)null);
                });

            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("ResultBase")
                        .HasColumnType("text")
                        .HasColumnName("result_base");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_case_session");

                    b.HasIndex("CaseId")
                        .HasDatabaseName("ix_case_session_case_id");

                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_case_session_court_id");

                    b.ToTable("case_session", (string)null);
                });

            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSessionAct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("ActKind")
                        .HasColumnType("text")
                        .HasColumnName("act_kind");

                    b.Property<int>("CaseSesionId")
                        .HasColumnType("integer")
                        .HasColumnName("case_sesion_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_case_session_act");

                    b.HasIndex("CaseSesionId")
                        .HasDatabaseName("ix_case_session_act_case_sesion_id");

                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_case_session_act_court_id");

                    b.ToTable("case_session_act", (string)null);
                });

            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSessionAmount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<bool>("FineIsPaid")
                        .HasColumnType("boolean")
                        .HasColumnName("fine_is_paid");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_case_session_amount");

                    b.HasIndex("CaseId")
                        .HasDatabaseName("ix_case_session_amount_case_id");

                    b.HasIndex("CaseSesionId")
                        .HasDatabaseName("ix_case_session_amount_case_sesion_id");

                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_case_session_amount_court_id");

                    b.HasIndex("JurorMandateId")
                        .HasDatabaseName("ix_case_session_amount_juror_mandate_id");

                    b.ToTable("case_session_amount", (string)null);
                });

            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Common.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Common.Counter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Common.CounterValueVM", b =>
                {
                    b.Property<int>("Value")
                        .HasColumnType("integer")
                        .HasColumnName("value");

                    b.ToTable("counter_value_v_ms", (string)null);
                });
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Common.MongoFile", b =>
                {
                    ...
                    b.Property<string>("ExpiredDescription")
                        .HasColumnType("text")
                        .HasColumnName("expired_description");

                    b.Property<string>("ExpiredUserId")
                        .HasColumnType("text")
                        .HasColumnName("expired_user_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Nomenclatures.NomCaseType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("nom_case_type", (string)null);
                });
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Nomenclatures.NomEducationRang", b =>
                {
                    ...
                    b.HasIndex("EducationId")
                        .HasDatabaseName("ix_nom_education_rang_education_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Register.JurorMandate", b =>
                {
                    ...
                    b.Property<string>("DateTerminationDescription")
                        .HasColumnType("text")
                        .HasColumnName("date_termination_description");
                    ...
                    b.HasIndex("MunicipalityId")
                        .HasDatabaseName("ix_juror_mandate_municipality_id");

                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_juror_mandate_parent_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseData", b =>
                {
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Nomenclatures.NomCaseType", "CaseType")
                        .WithMany()
                        .HasForeignKey("CaseTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_data_nom_case_type_case_type_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Common.CommonCourt", "Court")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_data_common_court_court_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseDismissal", b =>
                {
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Case.CaseData", "Case")
                        .WithMany("Dismissals")
                        .HasForeignKey("CaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_dismissal_case_data_case_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Common.CommonCourt", "Court")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_dismissal_common_court_court_id");

                    b.HasOne("ERSZ.Infrastructure.Data.Models.Register.Juror", "Juror")
                        .WithMany()
                        .HasForeignKey("JurorId")
                        .HasConstraintName("fk_case_dismissal_jurors_juror_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSelectionProtokol", b =>
                {
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Case.CaseData", "Case")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_selection_protokol_case_data_case_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Common.CommonCourt", "Court")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_selection_protokol_common_court_court_id");

                    b.HasOne("ERSZ.Infrastructure.Data.Models.Register.JurorMandate", "JurorMandate")
                        .WithMany()
                        .HasForeignKey("JurorMandateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_selection_protokol_juror_mandate_juror_mandate_id");

                    b.Navigation("Case");

                    b.Navigation("Court");

                    b.Navigation("JurorMandate");
                });
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSession", b =>
                {
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Case.CaseData", "Case")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_case_data_case_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Common.CommonCourt", "Court")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_common_court_court_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSessionAct", b =>
                {
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Case.CaseSession", "CaseSesion")
                        .WithMany("Acts")
                        .HasForeignKey("CaseSesionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_act_case_session_case_sesion_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Common.CommonCourt", "Court")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_act_common_court_court_id");

                    b.Navigation("CaseSesion");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSessionAmount", b =>
                {
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Case.CaseData", "Case")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_amount_case_data_case_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Case.CaseSession", "CaseSesion")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_amount_case_session_case_sesion_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Common.CommonCourt", "Court")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_amount_common_court_court_id");
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Register.JurorMandate", "JurorMandate")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_case_session_amount_juror_mandate_juror_mandate_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Nomenclatures.NomEducationRang", b =>
                {
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Nomenclatures.NomEducation", "Education")
                        ...
                        .HasConstraintName("fk_nom_education_rang_nom_education_education_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Register.JurorMandate", b =>
                {
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Ekatte.EkMunincipality", "Munincipality")
                        ...
                        .HasConstraintName("fk_juror_mandate_ek_munincipality_municipality_id");

                    b.HasOne("ERSZ.Infrastructure.Data.Models.Register.JurorMandate", "MandateParent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .HasConstraintName("fk_juror_mandate_juror_mandate_parent_id");
