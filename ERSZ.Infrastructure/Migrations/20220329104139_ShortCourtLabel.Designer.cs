...
namespace ERSZ.Infrastructure.Migrations
{
    ...
    [Migration("20220329104139_ShortCourtLabel")]
    partial class ShortCourtLabel
    {
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSelectionProtokol", b =>
                {
                    ...
                    b.HasIndex("JurorId")
                        .HasDatabaseName("ix_case_selection_protokol_juror_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSessionAmount", b =>
                {
                    ...
                    b.HasIndex("JurorId")
                        .HasDatabaseName("ix_case_session_amount_juror_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSelectionProtokol", b =>
                {
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Register.Juror", "Juror")
                        .WithMany()
                        .HasForeignKey("JurorId")
                        .HasConstraintName("fk_case_selection_protokol_jurors_juror_id");
            ...
            modelBuilder.Entity("ERSZ.Infrastructure.Data.Models.Case.CaseSessionAmount", b =>
                {
                    ...
                    b.HasOne("ERSZ.Infrastructure.Data.Models.Register.Juror", "Juror")
                        .WithMany()
                        .HasForeignKey("JurorId")
                        .HasConstraintName("fk_case_session_amount_jurors_juror_id");
