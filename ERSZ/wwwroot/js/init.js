(function () {
    ...
    $.fn.dataTable.ext.buttons.io_excel = {
        ...
        titleAttr: 'Excel',
        className: 'btn-ersz-default btn-success2',
        exportOptions: {
    ...
    $.fn.dataTable.ext.buttons.io_pdf = {
        ...
        titleAttr: 'Pdf',
        className: 'btn-ersz-default btn-danger2',
        autoClose: true,
        buttons: [
            {
                extend: 'pdf',
    ...
    $.fn.dataTable.ext.buttons.io_print = {
        ...
        titleAttr: 'Печат',
        className: 'btn-ersz-default btn-primary2',
        exportOptions: {
            "columns": "thead th:not(.noExport)"
        }
    };
    ...
    $.fn.dataTable.ext.buttons.io_colvis = {
        ...
        className: 'btn-ersz-default btn-info2'
    };
