...
namespace ERSZ.Core.Contracts
{
    ...
    public interface INomenclatureService : IBaseService
    {
        ...
        int GetCounterValue(int counterId, int valueCount = 1);
        List<SelectListItem> GetDDL_FinishedCase(bool addDefaultElement = true);
        int GetEkatteIdByCode(string ekatte);
    }
}
